<%@page import="com.wxjfkg.activiti.explorer.utils.ProcessDefinitionCache,org.activiti.engine.RepositoryService"%>
		...
		<tr>
			...
			<td>
				<c:if test="${p.suspended }">
					<a class="btn" href="update/active/${p.processInstanceId}">激活</a>
				</c:if>
				<c:if test="${!p.suspended }">
					<a class="btn" href="update/suspend/${p.processInstanceId}">挂起</a>
				</c:if>
			</td>
		</tr>
		</c:forEach>
