...
public class ProcessDefinitionController extends AbstractController {
    ...
    public ModelAndView readStartForm(@PathVariable("processDefinitionId") String processDefinitionId) throws Exception {
        ...
        String viewName = "process/start-process-form";
    ...
    public String startProcessInstance(@PathVariable("processDefinitionId") String pid, HttpServletRequest request, RedirectAttributes redirectAttributes) {
        ...
        if (hasStartFormKey) { // formkey表单
            ...
            StartFormData formData = formService.getStartFormData(pid);
        ...
        // 提交表单字段并启动一个新的流程实例
        ProcessInstance processInstance = formService.submitStartFormData(pid, formValues);
