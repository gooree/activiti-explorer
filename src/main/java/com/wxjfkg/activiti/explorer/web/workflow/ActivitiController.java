package com.wxjfkg.activiti.explorer.web.workflow;
...
import com.wxjfkg.activiti.explorer.cmd.JumpActivityCmd;
...
import com.wxjfkg.activiti.explorer.utils.WorkflowUtils;
...
public class ActivitiController extends AbstractController {
    ...
    public String redeployAll(@Value("${export.diagram.path}") String exportDir) throws Exception {
...
//    Context.setProcessEngineConfiguration(defaultProcessEngine.getProcessEngineConfiguration());
    ...
    public String deploy(@Value("${export.diagram.path}") String exportDir, @RequestParam(value = "file", required = false) MultipartFile file) {
    ...
    @ResponseBody
    public List<String> exportDiagrams(@Value("${export.diagram.path}") String exportDir) throws IOException {
